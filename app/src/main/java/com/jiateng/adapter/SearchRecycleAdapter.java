...
public abstract class SearchRecycleAdapter<T> extends RecyclerView.Adapter<SearchRecycleAdapter.BaseViewHolder> {

    protected List<T> datas;
    protected Context mContext;

    public SearchRecycleAdapter(List<T> datas, Context mContext) {
        this.datas = datas;
    ...
    @Override
    public void onBindViewHolder(SearchRecycleAdapter.BaseViewHolder holder, final int position) {
    ...
    public interface RvItemOnclickListener {
        ...
        void removeItemOnclick(int position);

        void intoHistoryPage(int position);
    }
